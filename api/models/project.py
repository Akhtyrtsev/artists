...
class Project(WithCreatedUpdated):
    client = models.ForeignKey(
        User, on_delete=models.SET_NULL, related_name="client_projects", null=True
    )
    artist = models.ForeignKey(
        User, on_delete=models.SET_NULL, related_name="artist_projects", null=True
    )
...
class ProjectMedia(WithCreatedUpdated):
    project = models.ForeignKey(
        Project, on_delete=models.SET_NULL, related_name="media", null=True
    )
    name = models.CharField(max_length=128)
