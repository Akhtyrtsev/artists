...
SILKY_PYTHON_PROFILER_BINARY = (
    True  # Enable collection of binary profiles (requires 'py-spy' tool)
)
...
SILKY_MAX_RECORDED_REQUESTS = (
    10  # Set the maximum number of recorded requests in the database
)

SILKY_MAX_RECORDED_REQUESTS_CHECK_PERCENT = (
    10  # Percentage of requests to check for exceeding the max recorded requests
)

SILKY_MAX_RECORDED_REQUESTS_AGE = (
    60 * 60
)  # Set the maximum age of recorded requests (in seconds)
